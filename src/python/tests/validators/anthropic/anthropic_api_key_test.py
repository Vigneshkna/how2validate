...
def test_validate_valid_key(mocker):
    """Test validate_anthropic_api_key with a valid key."""
    ...
    mock_active_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently active and operational."
    ...
    mock_active_response.data.provider = "anthropic"
    mock_active_response.data.services = "anthropic_api_key"
    ...
    assert result.data.validate.message == "The provided secret 'anthropic_api_key' is currently active and operational."
    ...
    assert result.data.services == "anthropic_api_key"
...
def test_validate_invalid_key(mocker):
    ...
    mock_inactive_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently inactive and not operational."
    ...
    mock_inactive_response.data.provider = "anthropic"
    mock_inactive_response.data.services = "anthropic_api_key"
    ...
    assert result.data.validate.message == "The provided secret 'anthropic_api_key' is currently inactive and not operational."
...
def test_validate_expired_key(mocker):
    ...
    mock_expired_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently inactive and not operational."
    ...
    mock_expired_response.data.provider = "anthropic"
    mock_expired_response.data.services = "anthropic_api_key"
...
def test_validate_malformed_key(mocker):
    ...
    mock_malformed_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently inactive and not operational."
    ...
    mock_malformed_response.data.provider = "anthropic"
    mock_malformed_response.data.services = "anthropic_api_key"
...
def test_validate_with_response_flag_true(mocker):
    ...
    mock_response_flag_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently active and operational."
    ...
    mock_response_flag_response.data.provider = "anthropic"
    mock_response_flag_response.data.services = "anthropic_api_key"
...
def test_validate_with_empty_secret(mocker, capsys):
    ...
    mocker.patch.object(sys, "argv", ["main.py", "-p", "anthropic", "-s", "anthropic_api_key", "-sec"])
...
def test_validate_with_none_secret(mocker):
    ...
    mock_with_none_secret_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently inactive and not operational."
    ...
    mock_with_none_secret_response.data.provider = "anthropic"
    mock_with_none_secret_response.data.services = "anthropic_api_key"
...
def test_validate_server_error(mocker):
    ...
    # Mock the requests.post response to raise an HTTPError
    mock_response = mocker.MagicMock()
...
def test_validate_unexpected_http_status(mocker):
    ...
    # Mock the requests.post response to return an unexpected HTTP status code
    mock_response = mocker.MagicMock()
    ...
    mock_unexpected_status_response.data.validate.message = "The provided secret 'anthropic_api_key' is currently inactive and not operational."
    ...
    mock_unexpected_status_response.data.provider = "anthropic"
    mock_unexpected_status_response.data.services = "anthropic_api_key"
