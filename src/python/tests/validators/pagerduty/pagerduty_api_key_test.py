...
def test_validate_valid_key(mocker):
    """Test validate_pagerduty_api_key with a valid key."""
    
    # Mock the how2validate.validators.pagerduty.pagerduty_api_key.requests.get response
    mock_response = mocker.MagicMock()
    mock_response.status_code = 200
    mock_response.text = '{"status": "success"}'  # Set text to a valid JSON string
    mock_response.json.return_value = {"status": "success"}
    mocker.patch("how2validate.validators.pagerduty.pagerduty_api_key.requests.get", return_value=mock_response)
    ...
    mock_active_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently active and operational."
    ...
    mock_active_response.data.provider = "pagerduty"
    mock_active_response.data.services = "pagerduty_api_key"
    ...
    # Call the function
    result = validate_pagerduty_api_key(
        provider="pagerduty",
        service="pagerduty_api_key",
        secret="valid_key",
        response_flag=True,
        report=None,
        is_browser=True
    ...
    assert result.data.validate.message == "The provided secret 'pagerduty_api_key' is currently active and operational."
    assert result.data.validate.response == '{"status": "success"}'
    assert result.data.validate.report == "email@how2validate.com"
    assert result.data.provider == "pagerduty"
    assert result.data.services == "pagerduty_api_key"
    assert result.timestamp

def test_validate_invalid_key(mocker):
    """Test validate_pagerduty_api_key with an invalid key."""
    ...
    mock_inactive_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently inactive and not operational."
    ...
    mock_inactive_response.data.provider = "pagerduty"
    mock_inactive_response.data.services = "pagerduty_api_key"
    ...
    assert result.data.validate.message == "The provided secret 'pagerduty_api_key' is currently inactive and not operational."
...
def test_validate_expired_key(mocker):
    """Test validate_pagerduty_api_key with an expired API key."""
    ...
    mock_expired_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently inactive and not operational."
    ...
    mock_expired_response.data.provider = "pagerduty"
    mock_expired_response.data.services = "pagerduty_api_key"
...
def test_validate_malformed_key(mocker):
    """Test validate_pagerduty_api_key with a malformed API key."""
    # Mock the how2validate.validators.pagerduty.pagerduty_api_key.requests.get response
    mock_response = mocker.MagicMock()
    mock_response.status_code = 401
    ...
    mock_malformed_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently inactive and not operational."
    ...
    mock_malformed_response.data.provider = "pagerduty"
    mock_malformed_response.data.services = "pagerduty_api_key"
...
def test_validate_with_response_flag_true(mocker):
    """Test validate_pagerduty_api_key with response_flag set to True."""
    ...
    mock_response_flag_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently active and operational."
    ...
    mock_response_flag_response.data.provider = "pagerduty"
    mock_response_flag_response.data.services = "pagerduty_api_key"
...
def test_validate_with_response_flag_false(mocker):
    """Test validate_pagerduty_api_key with response_flag set to False."""
...
def test_validate_without_response_flag(mocker):
    """Test validate_pagerduty_api_key with response_flag missing (default behavior)."""
...
def test_validate_with_provider_services(mocker):
    """Test validate_pagerduty_api_key with valid provider and service."""
    ...
    mock_provider_service_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently active and operational."
    mock_provider_service_response.data.validate.report = "email@how2validate.com"
    mock_provider_service_response.data.provider = "pagerduty"
    mock_provider_service_response.data.services = "pagerduty_api_key"
...
def test_validate_with_empty_secret(mocker, capsys):
    """Test validate_pagerduty_api_key with empty secret string."""

    # Mock sys.argv to simulate missing value for -sec
    mocker.patch.object(sys, "argv", ["main.py", "-p", "pagerduty", "-s", "pagerduty_api_key", "-sec"])
...
def test_validate_with_none_secret(mocker):
    """Test validate_pagerduty_api_key with None as secret."""
    ...
    mock_with_none_secret_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently inactive and not operational."
    ...
    mock_with_none_secret_response.data.provider = "pagerduty"
    mock_with_none_secret_response.data.services = "pagerduty_api_key"
...
def test_validate_server_error(mocker):
    """Test validate_pagerduty_api_key with HTTP 500 Internal Server Error."""

    # Mock the how2validate.validators.pagerduty.pagerduty_api_key.requests.get response to raise an HTTPError
    mock_response = mocker.MagicMock()
...
def test_validate_unexpected_http_status(mocker):
    """Test validate_pagerduty_api_key with an unexpected HTTP status code (e.g., 403 or 429)."""
    
    # Mock the how2validate.validators.pagerduty.pagerduty_api_key.requests.get response to return an unexpected HTTP status code
    mock_response = mocker.MagicMock()
    ...
    mock_unexpected_status_response.data.validate.message = "The provided secret 'pagerduty_api_key' is currently inactive and not operational."
    ...
    mock_unexpected_status_response.data.provider = "pagerduty"
    mock_unexpected_status_response.data.services = "pagerduty_api_key"
...
def test_validate_in_browser_environment(mocker):
    """Test validate_pagerduty_api_key in browser environment."""
...
def test_validate_in_non_browser_environment(mocker):
    """Test validate_pagerduty_api_key in non-browser environment."""
